...
Програмный подукт создан в качестве интерфейса управления социальной сетью для авторов из сторонних ресурсов.
...
Без аудентификации на проекте вам дотупен функционал:
- Получение токена;
